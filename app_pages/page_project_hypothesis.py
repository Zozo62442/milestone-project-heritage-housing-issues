...
def page_project_hypothesis_body():
    ...
    with st.expander("Validation Methods for Hypothesis 1"):
        st.write("1. **Correlation Analysis**: Pearson and Spearman correlations")
    ...
    with st.expander("Results for Hypothesis 1"):
        st.success(
            ...
            "**PARTIALLY CONFIRMED**: Condition is weaker than expected\n"
    ...
    st.write("**Validation Methods:**")
    with st.expander("Validation Methods for Hypothesis 2"):
    ...
    st.write("**Validation Results:**")
    with st.expander("Results for Hypothesis 2"):
        st.success(
    ...
    st.info(
        ...
        "GarageArea, KitchenQual, and BsmtFinSF1 ranked high in importance metrics.\n\n"
        "**Key Insights**:\n"
    ...
    st.success(
        ...
        "1. **Prioritise Quality**: Highlight property quality in listings.\n"
        "2. **Emphasize Living Space**: Market total living area and finished basement space.\n"
        "3. **Garage Value**: Larger garages (area) clearly add value.\n"
        "4. **Kitchen ROI**: Higher kitchen quality adds significant premium.\n"
